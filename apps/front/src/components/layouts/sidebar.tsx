        ...
        <div className="relative">
          ...
          {orgMenuOpen && !collapsed && (
            <>
              ...
              <div className="absolute left-0 right-0 top-full mt-2 z-50 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-lg overflow-hidden animate-fade-in">
